...
- (void)getWeather:(CLLocation *)location {
    if (weatherCalled == 0) {
        ...
        //freezing rain
        else if(40 > weather.Fvalue && (([weather.currentDescription rangeOfString:@"Light rain" options:NSCaseInsensitiveSearch].location != NSNotFound) || ([weather.currentDescription rangeOfString:@"light freezing rain" options:NSCaseInsensitiveSearch].location != NSNotFound))) {
        ...
        else if(40 > weather.Fvalue && (([weather.currentDescription rangeOfString:@"Moderate rain" options:NSCaseInsensitiveSearch].location != NSNotFound) || ([weather.currentDescription rangeOfString:@"moderate freezing rain" options:NSCaseInsensitiveSearch].location != NSNotFound))) {
        ...
        else if(40 <= weather.Fvalue && (([weather.currentDescription rangeOfString:@"Heavy rain" options:NSCaseInsensitiveSearch].location != NSNotFound) || ([weather.currentDescription rangeOfString:@"Torrential rain"].location != NSNotFound))) {
